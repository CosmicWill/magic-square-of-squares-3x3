...
| A. Auel, B. Singer, "The algebraic geometry of 3×3 magic squares of squares," arXiv:2609.09351 (8 Sep 2026). The same surface $V\subset\mathbb P^8$ (six quadrics, 256 nodes over $\mathbb Q(\zeta_8)$): Aut = $D_4\ltimes\mu_2^9/\mu_2$ of order 2048 (Gale duality), Hodge diamond $p_g = 111$, $h^{1,1} = 544$, $b_2 = 766$, simply connected, $c_1^2 = 576$, $c_2 = 768$ (all matching A5/A7/A8), geometric Picard rank $518\le
...
ho\le 544$ from 1204 explicit divisors, no lines over $ar{\mathbb Q}$, del Pezzo / K3 (one of Picard rank 19) / Enriques coordinate projections, new biquadratic squares over $\mathbb Q(i,\sqrt5)$; proposes the étale Brauer–Manin obstruction on the open locus of distinct entries as a potential route to nonexistence. | **READ** (introduction and theorems, 2026-09-16; entry 146); `papers/2609.09351-auel-singer.pdf` |
