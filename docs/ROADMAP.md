...
**Outcome of the programme (entry 144).**  R3 decided through its genus-2 companion (rank 0, the group proved): its eight classes dead.  R1, R2 (rank ≥ 3 = genus), R4, R5 (rank ≥ 4 = genus) closed by rank, no hidden involutions; G2 rank 3, G3 rank 2; the analytic ranks timed out; $I_{139}\cong D_{139}$ (equal Euler factors, equal Igusa–Clebsch invariants), so its rank is 3.  The calculator's curve arithmetic on the shape survivors is exhausted: 248 open = 124 + 124.
