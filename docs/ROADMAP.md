...
- *Closed shapes:* every ω ≤ 2 shape (A3.10 and its companions); at ω = 3 the $(1,1,1)$ box is dead — **Theorem A3.PQR** (entry 138): no magic square of nine distinct squares has a centre whose split part is a product of three distinct first-power primes.
