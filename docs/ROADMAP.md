...
mass and teaches the most per result.  Status: 2944 quadruple classes;
821 dead uniformly in the primes; 540 Faltings-finite; 316 with a
genus-0 Pythagorean family on the projection; 1267 high-bidegree, not
yet analysed.  Next in order: (a) the third-frame lift of the 316
families and the pullback of the high-degree components; (b) quotient
towers for the 540 finite models; (c) the (2,1,1) box and the test of
whether the killing curves stay in one finite family.
