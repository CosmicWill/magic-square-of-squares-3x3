...
*Current checkpoint: 2026-09-08, reviewed through entry 132. The verification registry contains 220 checks (entries 133–138 since the review: the binomial square root, the symmetry tower, and the (1,1,1) box dead — entry 138); this is not a claim that each proof has a complete automated certificate replay. See the [comprehensive review](REVIEW-AND-PLAN-2026-09-08.md), [research log](../RESEARCH_LOG.md), and [current roadmap](ROADMAP.md#r14-current-plan-after-the-recent-campaigns-2026-09-08).*

## Current arithmetic checkpoint

**Entry 138 (2026-09-08): the (1,1,1) box is dead.** Every one of its 2,944 classes is excluded — the last sixteen on their other frames through one genus-2 curve K, whose rational points Magma's Chabauty decides (rank 1, the Mordell–Weil group proved) — so no 3×3 magic square of nine distinct squares has a centre whose split part is a product of three distinct first-power primes (Theorem A3.PQR, [A3 §2.62](attacks/A3-simultaneous-congrua.md)). The symmetry tower now sweeps every frame of every open class ((2,1,1): 102 of 242 dead, (3,1,1): 64 of 220 dead) and lifts endpoint points as fibers of the composed quotient map, the point at infinity included. External inputs are recorded verbatim (`compute/qc`). The existence question remains open.
...
The [research inventory](RESEARCH-INVENTORY.md) contains the 296 certified finite records (0 + 140 + 156 after entry 138: the (1,1,1) box is dead), with exact candidate and source provenance. It excludes provisional and higher-prime height-only records; the review lists the whole recorded frontier. The engine applies A3.PC before curve decisions. [A10](attacks/A10-cancellation-descent.md) proves that the relaxed Laurent system has no further valuation-support obstruction, and derives leading-square restrictions and unit congruences. A global descent from those congruences is still an open investigation.
