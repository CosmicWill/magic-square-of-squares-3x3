...
*Current checkpoint: 2026-09-08, reviewed through entry 132. The verification registry contains 276 checks (entries 133–148 since the review: the binomial square root, the symmetry tower, the (1,1,1) box dead — entry 138 —, five more curves decided by Magma — entry 139 — the twisted endpoints — entry 140 — the curve D₁₄₀ decided — entry 141 — the Prym test on the route-less families — entry 142 — the census of the open classes — entry 143 — the genus-3 endpoint R₃ decided — entry 144 — the second-level quotient census — entry 145 — the theory pivot and K3 trace atlas — entries 146–147 — and Picard-module bookkeeping with a source-verified intersection-matrix obstruction — entry 148 — the proof-alternatives branch integrated — entry 149 — and the weight-3 newform test of the two open Horikawa types — entry 148 addendum — and the $\eta_\star$-web made explicit, W1 resumed — entry 150 — and Lemma T, tangency at the triple points — entry 151 — and Theorem A8.20, the cubic level of the web closed — entry 152 — with the quartic level as modular evidence — entry 152 addendum); this is not a claim that each proof has a complete automated certificate replay. See the [comprehensive review](REVIEW-AND-PLAN-2026-09-08.md), [research log](../RESEARCH_LOG.md), and [current roadmap](ROADMAP.md#r14-current-plan-after-the-recent-campaigns-2026-09-08).*

## Current arithmetic checkpoint

**Entry 148:** an exact five-row minor of the archived Auel–Singer matrix has two positive directions, so the matrix cannot be a divisor intersection matrix. The verifier extracts the witness from the full source. The Picard-module calculation gives 335 algebraic dimensions independently of candidate K3/Horikawa identifications; proposed upper bounds 456 and 454 remain conditional. See [A3 §2.70](attacks/A3-simultaneous-congrua.md#270-picard-module-bookkeeping-and-an-exact-intersection-matrix-obstruction-entry-148). No new magic-square classes are excluded.

**Entry 138 (2026-09-08): the (1,1,1) box is dead.** Every one of its 2,944 classes is excluded — the last sixteen on their other frames through one genus-2 curve K, whose rational points Magma's Chabauty decides (rank 1, the Mordell–Weil group proved) — so no 3×3 magic square of nine distinct squares has a centre whose split part is a product of three distinct first-power primes (Theorem A3.PQR, [A3 §2.62](attacks/A3-simultaneous-congrua.md)). The symmetry tower now sweeps every frame of every open class ((2,1,1): 102 of 242 dead, (3,1,1): 64 of 220 dead) and lifts endpoint points as fibers of the composed quotient map, the point at infinity included. Entry 139 added five Magma-decided genus-2 curves and re-swept: (2,1,1) 8 of 140 and (3,1,1) 16 of 156 more dead, leaving 132 + 140 open. Entry 140 turned the admissibility condition and the fiber discriminants into quadratic twists of the tower's models: (2,1,1) 0 of 132 and (3,1,1) 8 of 140 more dead, leaving 132 + 132 open. Entry 141 decided the twisted curve D₁₄₀ (Magma, the index certified) and killed 8 of the 8 (3,1,1) classes that meet it, leaving 132 + 124 open. Entry 142 proved sixteen of the 88 route-less (2,1,1) classes beyond every quotient route through curves of genus ≤ 2 (their components' Jacobians have no factor of dimension ≤ 2; Sage function fields, validated against Magma); tallies unchanged. Entry 143 classified the 256 open classes by the best endpoint genus a whole frame reaches (24 genus-0, 16 rank-1 elliptic, 32 rank-≥2 genus-2, 40 genus-3, 24 genus-4, 32 genus-5, 88 without endpoint), found five hyperelliptic curves of genus 3–4 covering the 64 genus-3/4 classes, prepared the Magma programme magma_tower143.m and wrote the review ROADMAP R.16. Entry 144 decided the genus-3 endpoint R₃ through its genus-2 companion (Magma: rank 0, the group proved; three points) and killed 8 of the 8 (2,1,1) classes that meet it, leaving 124 + 124 open. Entry 145 iterated the classical quotients on every endpoint model of the 248 open classes: sixteen (3,1,1) classes gain a genus-2 curve at level 3; R₅'s eight are closed by rank (T₅ = (z+4)G₂ is the LMFDB curve 230224.a.920896.1 of rank 2) and the new curves U₁, U₂ are undecided (2-Selmer bound 4, rank ≥ 1); tallies unchanged. External inputs are recorded verbatim (`compute/qc`). The existence question remains open.

The magic-square existence question remains open. The prime-column lemma A3.PC is a necessary condition for every exponent shape and every number of split primes, and excludes every free-frame class. The height system A3.HS adds exact unit-cancellation inequalities valid for every choice of primes. After entries 131-134, the full (1,1,1) ledger contains **2,928 dead / 16 open finite classes**. The additional (2,1,1) campaign has 79,126 dead / 242 open finite (entry 137); the additional (3,1,1) campaign has 287,858 dead / 1,025 open finite and 1,181 provisional. The four- and five-prime all-one height campaigns leave 3,152 and 28,910 undecided classes. Certified finite means a finiteness argument is recorded, not that all rational points have been found.

The September 8 review found exact maps from the eight then-remaining (1,1,1) tower records to two bielliptic genus-2 curves with elliptic ranks (1,1), recorded in the [quotient probe](../compute/genus25_quotient_probe.py); entry 134 (Theorem A3.SQ, the binomial square root) then killed those eight records and most other open classes of every campaign, leaving (1,1,1) at 2,916 dead / 28 open; entry 136 (the symmetry tower) then killed twelve more: 2,928 dead / 16 open. Both share an elliptic factor with rational 5-torsion, beyond the current QC wrapper's assumptions. Complete point and lift checks remain pending; no new exclusions are claimed. The review also independently verified all 204 bounds behind the 68 capped-search exclusions and identified a gap in the reusable verifier's validation of those bounds.

The [research inventory](RESEARCH-INVENTORY.md) contains the 248 certified finite records (0 + 124 + 124 after entry 144), with exact candidate and source provenance. It excludes provisional and higher-prime height-only records; the review lists the whole recorded frontier. The engine applies A3.PC before curve decisions. [A10](attacks/A10-cancellation-descent.md) proves that the relaxed Laurent system has no further valuation-support obstruction, and derives leading-square restrictions and unit congruences. A global descent from those congruences is still an open investigation.
